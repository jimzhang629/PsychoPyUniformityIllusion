...
while True:
    ...
    for gaze_pos in gaze_positions:
        ...
        if 0 <= norm_gp_x <= 1 and 0 <= norm_gp_y <= 1:
            print(
                "gaze on surface: {}\t, normalized coordinates: {},{}".format(
                    surface_name, norm_gp_x, norm_gp_y
                )
            )
    ...
    thisExp = data.ExperimentHandler(name=expName, version='',
        ...
        originPath='C:\\Users\\hesselmann\\Desktop\\Uniformity Illusion PsychoPy\\UniformityIllusion_lastrun.py',
    ...
    for thisPracticeTrialsLoop in PracticeTrialsLoop:
        ...
        # update component parameters for each repeat
        # keep track of which components have finished
        Practice_TrialsComponents = [image, text]
