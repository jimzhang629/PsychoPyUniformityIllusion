...
expName = 'imagestest'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\hesselmann\\Desktop\\stimuli\\imagestest_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('..\\\\Mappe1.xlsx', selection="'0:5'"),
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if imageTest.status == STARTED:
            ...
            if tThisFlipGlobal > imageTest.tStartRefresh + 1.0-frameTolerance:
    ...
    trials.addData('imageTest.started', imageTest.tStartRefresh)
    trials.addData('imageTest.stopped', imageTest.tStopRefresh)
    thisExp.nextEntry()
