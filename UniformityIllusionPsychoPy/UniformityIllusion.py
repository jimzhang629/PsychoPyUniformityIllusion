...
for thisPracticeTrialsLoop in PracticeTrialsLoop:
    ...
    while continueRoutine:
        ...
        if blank_screen.status == NOT_STARTED and frameN == 2 or frameN == 5 or frameN == 7 or frameN == 10: #set the frame numbers that the blank screen flashes at
            # keep track of start time/frame for later
        ...
        if blank_screen.status == STARTED:
            blank_screen.setOpacity((math.floor(frameN/7) / 10))
        # *text* updates
